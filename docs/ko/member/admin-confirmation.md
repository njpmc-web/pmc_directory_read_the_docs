...
<figure class="device-shot">
  <img src="../../assets/images/review-framed/auth-unregistered.png" alt="등록된 교인 휴대폰 번호를 찾을 수 없다는 안내와 관리자 확인 요청 버튼이 표시된 로그인 화면">
  <figcaption>미등록 번호 안내 아래의 <strong>관리자 확인 요청</strong>을 선택합니다.</figcaption>
</figure>
<figure class="device-shot">
  <img src="../../assets/images/review-framed/lookup-phone.png" alt="관리자 확인 요청의 휴대폰 본인 인증 번호 입력란과 인증번호 받기 버튼">
  <figcaption>연락받을 휴대폰 번호로 <strong>인증번호 받기</strong>를 선택합니다.</figcaption>
</figure>
<figure class="device-shot">
  <img src="../../assets/images/review-framed/lookup-otp-entry.png" alt="관리자 확인 요청의 인증번호 입력란과 번호 인증 버튼이 표시된 화면">
  <figcaption>SMS 인증번호를 입력하고 <strong>번호 인증</strong>을 선택합니다.</figcaption>
</figure>
<figure class="device-shot">
  <img src="../../assets/images/review-framed/lookup-profile-filled.png" alt="인증한 전화번호 이름 배우자 이름 고정된 주소 교적번호 생년월일과 선택 메모가 입력된 본인 정보 확인 화면">
  <figcaption>필수 정보와 알고 있는 선택 정보를 입력하고 주소를 확인합니다.</figcaption>
</figure>
<figure class="device-shot">
  <img src="../../assets/images/review-framed/lookup-profile-candidates.png" alt="이름 배우자 이름 주소 일치 배지가 있는 교적 후보와 후보 없이 검토 요청 선택지가 표시된 화면">
  <figcaption>본인 후보를 선택하거나 후보 없이 관리자 검토를 요청합니다.</figcaption>
</figure>
<figure class="device-shot">
  <img src="../../assets/images/review-framed/lookup-success.png" alt="관리자 확인 요청 번호와 처리 결과를 인증한 휴대폰으로 안내한다는 접수 완료 화면">
