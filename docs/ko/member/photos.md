...
<figure class="device-shot">
  <img src="../../assets/images/review-framed/photo-family.png" alt="가정 정보 카드의 가족 대표 사진과 사진 변경 요청 카메라 버튼이 표시된 화면">
...
<figure class="device-shot">
  <img src="../../assets/images/review-framed/photo-family-crop.png" alt="가족 사진 4대3 자르기 영역과 확대 축소 회전 초기화 및 완료 도구가 표시된 사진 맞추기 화면">
...
<figure class="device-shot">
  <img src="../../assets/images/review-framed/photo-family-notes.png" alt="선택한 가족 사진 미리보기와 Crop 사진 변경 선택 메모 및 요청 보내기 버튼이 표시된 화면">
...
<figure class="device-shot">
  <img src="../../assets/images/review-framed/photo-family-success.png" alt="가족 사진 변경 요청 접수 완료 안내와 Requested 사진이 표시된 가정 정보 화면">
