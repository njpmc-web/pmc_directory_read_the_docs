...
<figure class="device-shot">
  <img src="../../assets/images/review-framed/auth-phone-complete.png" alt="휴대폰 번호 입력 후 인증번호 받기 버튼이 활성화된 회원 로그인 화면">
...
<figure class="device-shot">
  <img src="../../assets/images/review-framed/auth-otp-sent.png" alt="6자리 인증번호 입력 칸과 로그인 버튼 및 인증번호 전송 완료 안내가 있는 화면">
